...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT(
    ...
    RESET,   _______, _______, _______, KC_VOLU, ES_LBRC, ES_RBRC, KC_4,    KC_5,    KC_6,    KC_SCLN,          _______,
    _______, _______, _______, _______, KC_VOLD, ES_LCBR, ES_RCBR,          KC_1,    KC_2,    KC_3,    KC_UP,   _______,
  ...
  [_FN2] = LAYOUT(
    ...
    _______, KC_NUBS, _______, KC_DEL,  KC_PGDN, KC_END,  _______,          _______, _______, _______, _______, _______,
